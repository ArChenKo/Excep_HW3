...
public class Checker {
            ...
            if (Character.isLetter(string.charAt(0))) {
                if (string.length() == 1) {
                    ...
                    if (this.lastName == null) {
                        ...
                        fullErrorsMessages.append("Как ФИО распознано больше элементов, чем положено.\n");
                    }
                }
            } else {
                ...
                if (string.matches("[0-9]{2}\\.[0-9]{2}\\.[0-9]{4}")) {
                    if (this.birthDate == null) {
                        ...
                        fullErrorsMessages.append("Дата рождения должна быть только одна, а обнаружено больше: '"
                    ...
                    if (this.phoneNumber == null) {
                        ...
                        fullErrorsMessages.append("Телефонный номер может быть только один, но распознано несколько: '"
    ...
    private LocalDate checkBirthDate(String inputString) throws BDException {
        try {
            return LocalDate.parse(inputString,
                    DateTimeFormatter.ofPattern("dd.MM.yyyy"));
        } catch (DateTimeParseException e) {
            throw new BDException(inputString);
        }
    }
